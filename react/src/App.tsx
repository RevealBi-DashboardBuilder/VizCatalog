...
export default function Builder() {
  ...
  const addVisualization = async (
    ...
    // Check if the visualization already exists in the selectedVisualizations array
    ...
    if (exists) {
      // Display an error message if the visualization already exists
              ...
              >
                <div className="flex min-w-0 gap-x-4">
                  <img
                    ...
                    src={RevealSdkSettings.serverUrl + `\\images\\png\\` + viz.vizChartType + `.png`}
                    alt=""
                  />
