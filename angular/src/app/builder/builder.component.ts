...
export class BuilderComponent implements OnInit, OnDestroy {
  ...
  // variables to store the revealView and dashboard in the listItemClick method
   ...
   if (this.prevSelected) {
    ...
    public iconClick(item: VisualizationChartInfo, event: MouseEvent) {    
      ...
      if (this.selectedVisualization) {
        // Check if the visualization already exists in the collection
        const exists = this.vizCollection.some(
          (viz) => viz.vizId === this.selectedVisualization!.vizId
        );
        ...
        // Add the visualization if it does not already exist
